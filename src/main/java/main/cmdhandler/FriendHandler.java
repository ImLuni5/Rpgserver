        ...
        switch (args[0]) {
            ...
            case "수락":
                if (FriendRequestTimer.getPlayerInviteTime().containsKey(player)) {
                    ...
                    player.sendMessage(Main.INDEX + "당신은 이제 " + FriendRequestTimer.getPlayerInviteOwner().get(player) + "님과 친구입니다.");
                    FriendRequestTimer.getPlayerInviteOwner().get(player).sendMessage(Main.INDEX + "당신은 이제 " + player + "님과 친구입니다.");
